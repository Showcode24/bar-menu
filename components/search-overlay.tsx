...
export default function SearchOverlay({ isOpen, onClose, onDrinkSelect }: SearchOverlayProps) {
  const {
    searchQuery,
    setSearchQuery,
    searchResults,
          ...
          <div className="h-full flex flex-col">
            <div className="container mx-auto px-4 py-4">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold text-amber-500">Search</h2>
                <button
                  onClick={onClose}
              ...
              <form onSubmit={handleSearch} className="mb-6">
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-zinc-900 border border-zinc-800 rounded-lg px-4 py-3 pr-10 text-white focus:outline-none focus:ring-2 focus:ring-amber-500"
                  />
