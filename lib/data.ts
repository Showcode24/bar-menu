  ...
  },
{
  ...
  },
  {
    ...
    price: 67000,
    category: "spirits",
    image: "https://winest.hk/cdn/shop/products/11027031-1_1580611522_1080x.png?v=1613024020",
...
},
{
  ...
  // MEALS - GRILLED ITEMS
  {
    ...
    description: "Charcoal-grilled whole catfish served with spicy pepper sauce and side of choice.",
    price: 12000,
    category: "grill",
    image: "/images/catfish-barbeque.jpg",
    tags: ["Grilled", "Spicy", "Seafood"],
    ingredients: ["Catfish", "Pepper", "Onions", "Oil", "Spices"],
    popular: true,
  },
  // {
  //   id: "meal-2",
  //   name: "Croaker Fish Barbecue",
  //   description: "Grilled croaker fish served with pepper mix and garnished sides.",
  //   price: 4000,
  //   category: "grill",
  //   image: "/images/croaker.jpg",
  //   tags: ["Grilled", "Seafood"],
  //   ingredients: ["Croaker fish", "Spices", "Onions", "Pepper sauce"],
  // },
  // {
  //   id: "meal-3",
  //   name: "Grilled Turkey Wings",
  //   description: "Juicy turkey wings marinated and grilled to perfection.",
  //   price: 3000,
  //   category: "grill",
  //   image: "/images/grilled-turkey.jpg",
  //   tags: ["Poultry", "Spicy"],
  //   ingredients: ["Turkey", "Marinade", "Spices", "Onion"],
  //   popular: true,
  // },
  {
    id: "meal-4",
    name: "Grilled Chicken",
    description: "Well-seasoned grilled chicken, available in spicy or classic flavors.",
    price: 6500,
    category: "grill",
    image: "/images/grilled-chicken.webp",
    tags: ["Chicken", "Spicy"],
    ingredients: ["Chicken", "Pepper", "Seasoning"],
  },
  {
    id: "meal-5",
    name: "Beef Suya",
    description: "Popular Nigerian street-style spicy grilled beef skewers.",
    price: 5000,
    category: "grill",
    image: "/images/Beef-Suya.jpg",
    tags: ["Street food", "Beef", "Spicy"],
